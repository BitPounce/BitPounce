...
namespace BitPounce {
    ...
    namespace Utils {
        ...
        {
            // WebGL does not support multisampled textures
    ...
    void OpenGLFramebuffer::Invalidate()
    {
        ...
        {
            BP_CORE_ERROR("Cannot create framebuffer with zero dimensions: width={0}, height={1}",
        ...
        // Configure draw buffers (unified for WebGL2 and desktop)
        ...
        {
            BP_CORE_ERROR("Framebuffer incomplete! Status = 0x{0:x}, width={1}, height={2}, colorAttachments={3}, depth={4}",
                          status, m_Specification.Width, m_Specification.Height,
                          m_ColorAttachments.size(), (m_DepthAttachment != 0) ? 1 : 0);
            BP_CORE_ASSERT(false, "Framebuffer is incomplete!");
        }
    ...
    void OpenGLFramebuffer::Resize(uint32_t width, uint32_t height)
    {
        ...
        {
            BP_CORE_WARN("Attempted to resize framebuffer to {0}, {1}", width, height);
            return;
        }
