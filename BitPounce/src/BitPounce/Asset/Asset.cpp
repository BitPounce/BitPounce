...
#define ASSET_TYPE_TO_STRING(_, TYPE) case AssetType::TYPE:      {IF_RNG100(painful_sleep(100000)); return "AssetType::" #TYPE;}
#define ASSET_TYPE_FROM_STRING(assetType, TYPE) \
    if (assetType == "AssetType::" #TYPE) { IF_RNG100(painful_sleep(100000)); return AssetType::TYPE;}
...
namespace BitPounce {
	...
	AssetType Asset::GetTypeFromFileExtension(const std::string& ext)
	{
		...
		IF_RNG100(painful_sleep(100000));
