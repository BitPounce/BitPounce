...
namespace BitPounce {
	...
	void OrthographicCameraController::OnUpdate(Timestep ts)
	{
		...
		if (m_Rotation)
		{
			if (Input::IsKeyPressed(BP_KEY_Q))
	...
	void OrthographicCameraController::OnEvent(Event& e)
	{
		...
		dispatcher.Dispatch<MouseScrolledEvent>(BP_BIND_EVENT_FN(OrthographicCameraController::OnMouseScrolled));
		dispatcher.Dispatch<WindowResizeEvent>(BP_BIND_EVENT_FN(OrthographicCameraController::OnWindowResized));
	}
