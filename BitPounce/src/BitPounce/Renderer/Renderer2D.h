...
namespace BitPounce {
	...
	public:
		...
		static void DrawQuad(const glm::mat4& transform, const glm::vec4& colour, int entityID = 0);
		static void DrawQuad(const glm::mat4& transform, const Ref<Texture2D>& texture, const glm::vec4& tintColour = glm::vec4(1.0f), float tilingFactor = 1.0f, int entityID = 0);
		static void DrawQuad(const glm::mat4& transform, const Ref<Texture2D>& texture, const std::array<glm::vec2, 4> uvs, const glm::vec4& tintColour = glm::vec4(1.0f), int entityID = 0);
		static void DrawQuad(const glm::mat4& transform, const Ref<Texture2D>& texture, const glm::u32vec2 subTexSize, const glm::u32vec2 subTexIndex, const glm::vec4& tintColour = glm::vec4(1.0f), int entityID = 0);
