...
namespace BitPounce
{
	...
	{
		BP_CORE_ASSERT(!Exists(name), "Shader already exists!");
	...
	BitPounce::Ref<BitPounce::Shader> ShaderLibrary::Load(const std::string& filepath)
	{
	...
	BitPounce::Ref<BitPounce::Shader> ShaderLibrary::Load(const std::string& name, const std::string& filepath)
	{
		auto shader = Shader::Create(filepath);
		Add(name, shader);
		return shader;
	...
	BitPounce::Ref<BitPounce::Shader> ShaderLibrary::Get(const std::string& name)
	{
		BP_CORE_ASSERT(Exists(name), "Shader not found!");
